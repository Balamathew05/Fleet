...
public class UserController {
	...
	public void registerAdmin(@RequestBody User user) throws AdminException, AddressException, MessagingException {
		userService.insertUser(user);
	}

//	@PutMapping("/Update")
//	public ResponseEntity<Admin> updateAdminHandler(@RequestBody Admin admin, @RequestParam String uuid)
...
//	public ResponseEntity<Admin> deleteAdmin(@RequestParam("adminId") Integer adminId,
//			@RequestParam("uuid") String uuid) throws AdminException, CurrentUserSessionException {
